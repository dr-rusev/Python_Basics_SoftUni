...
# освен ако не е есен - тогава нямат допълнителна отстъпка, която се начислява след
...
rest = budget - price
if rest >= 0:
    print("Yes! You have " + f'{rest:.2f}' + " leva left.")
else:
    rest = -rest
    print("Not enough money! You need " + f'{rest:.2f}' + " leva.")
